...
public class ArticleRepositoryBD extends RepositoryBDImpl<Article> implements ArticleRepository {
    ...
    public void insert(Article article) {
        try {
            ...
            this.getConnection();  // Ensure this method returns a valid Connection object
            this.initPreparedStatement(sql);  // Ensure this initializes `this.ps` properly
            ...
            this.ps.executeUpdate();  // Ensure executeUpdate() is called on `this.ps`
            ...
            try {
                this.closeConnection();  // Ensure this closes the connection properly
            } catch (SQLException e) {
                e.printStackTrace();
            }
        }
