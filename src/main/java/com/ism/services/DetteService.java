...
public interface DetteService {
    ...
    void createDetteForClientWithArticlesAndPayment(Client client, List<Article> articles, Double montant, Double montantVerser, LocalDate date, Double montantPaiement, Double prixVente, Integer qteVendu );
}
